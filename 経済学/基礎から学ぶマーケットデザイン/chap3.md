...
- インターネット上で検索することを「ググる」と呼ぶほどに「**Google**」の知名度は圧倒的です。Googleなどの検索サイトでは、検索ワードを入力すると画面上には該当する可能性の高い情報に加え、それらに関連した企業の広告が提示されます。この広告の掲載順序を決定するのにオークションが利用されており、**広告オークション**または**キーワードオークション**と言います。
- 広告オークションは基本的にインターネットの利用者が自社に関連したキーワードを検索するたびに、自社のウェブサイトへのリンクを検索結果の周辺に表示させ、一定の広告料をGoogleなどの検索サイトに支払うという仕組みです。検索サイトの運営企業にとっては起業収益のうちこの広告オークションからの収入が多くの割合を占めます。例えば、$\text{Edelman et al.（2007）}$は2005年時点でGoogleの収益（約61億ドル）の$98\%$以上が広告オークションからの収入によるものだと示しており、また、日本でも電通によれば2009年で227億円の収入があったようです（$\text{Fukuda et al., 2013}$）。

#### 一般化された2位価格（GSP：Generalized Second-Price）方式

- 1990年代前半の広告オークションにおいて、広告料は検索サイトとの交渉で決まり、また広告料が高かったため参加企業はあまりいませんでした。そこで1990年代後半に広告料をオークションで決定する方式に変えました。試行錯誤の末、$\text{Edelman et al.（2007）}$の研究で発表された当時に使用していた方式のエッセンスは次のようなものです。
  1. 広告を出したい企業はどのような言葉が検索されたときに自社のウェブサイトを表示してもらいたいか、そのキーワードを選び、そのキーワードに対する価格を付ける。
  2. 同じキーワードに対して1番高い価格をつけた企業のサイトが検索結果周辺に表示される広告枠のトップに表示される。
  3. 2番目に高い価格をつけた企業のサイトはその下に表示され、以下同様に広告枠の数が埋まるまで、高い価格をつけた順に上から各企業のサイトへのリンクが表示されます。
- 広告掲載が決まった企業が支払う広告料はインターネットの利用課金されることになります。1クリックあたりのその金額（クリック単価）は先ほどの入札で各企業がついた価格によって決まります。具体的には1番高い価格をつけた企業は2番目に高い価格を支払い、2番目に高い価格をつけた企業は3番目に高い価格を支払い、というように自分よりも1つ買いになった企業のつけた価格を支払います（実際には最小単位価格分高い値段を支払います）。
  - 【**広告料の補足**】このクリック単価について、金融・保険関連のような「**ビッグキーワード**」の相場は300円前後だと言われており、本やCDといった一般商品の場合は50〜100円前後のようです。
- それぞれの広告枠は平均クリック数などが違うためそれぞれ異質財と考えられ、**異質財の同時オークション**の例になっています。
- 以上のようなオークションは**一般化された2位価格方式（GSP方式）** と呼ばれています。理由は<ruby>広告枠が一つしかない場合<rt>⚫⚫⚫⚫⚫⚫⚫⚫⚫⚫⚫⚫</rt></ruby>には2位価格オークションと一致するからです。**しかし**、2つ以上の広告枠がある場合、$k$位（$k\geqq 2$）の企業は$k+1$位の企業のつけた価格を支払うため2位価格オークションの拡張にはなっておらず、加えて**耐戦略性も満たしません**。

#### 【例】GSP方式の広告オークション

> いま、「パリ旅行」というキーワードに登録しようとしている旅行会社3社、$A$社、$B$社、$C$社が存在し、$A$社、$B$社、$C$社の1クリックあたりの広告枠に対する評価値はそれぞれ$600$円/回、$300$円/回、$100$円/回とします。また、1時間あたりで見て1位の広告枠の平均クリック数は100回、2位の広告枠の平均クリック数は90回だとします。
> 　全ての企業が評価値に等しい価格を入札したとすると、$A$社と$B$社が落札することになり、それぞれ1クリックあたり300円及び100円を支払うことになります。この時の$A$社の利得は$(600-300)\times 100=30,000$円になります。ここで、$A$社が評価値よりも低い価格、例えば、200円を入札するとします。この時、$A$社は2位（$B$社が1位）になり、その利得は$C$社の100円を用いて$(600-100)\times 90=45,000$円となります。つまり、<font color=red>評価値に等しい価格を入札した時よりも利得が高くなり、耐戦略性を満たさないメカニズムである</font>ことがわかります。
